...
public class EmailUtil  {
	...
	public void sendOtpEmail(String email, String otp) throws MessagingException {
		mailer.send(email, "Xác minh - OTP","<h1>🛒 BachHoa<h1/> <h2>Mã xác nhận của bạn là: <h2/><h1 style='color: red'>" + otp + "<h1/>");
	}
	...
	public void sendSetPasswordEmail(String email) throws MessagingException {
		mailer.send(email,"Thay đổi mật khẩu của bạn",
			...
			+ "<div> <a href='http://localhost:8081/set-password' target='_blank'> Bấm vào đây để đổi mật khẩu.</a> </div>");
	}
}
