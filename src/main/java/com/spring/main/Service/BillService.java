...
public class BillService {
	...
	public Page<Bill> searchBetween(Timestamp fromDate, Timestamp toDate, Pageable page, Integer storeID) {
		return billJPA.SearchBetween2Date(fromDate, toDate, page, storeID);
	}
